...
#             if ln_exit_code == 0:
#                 results_report.main("c:\\temp\\results_report.json", "Publish Shape File via Portal", "Pass",
#                                     "Successfully published file")
#             else:
#                 results_report.main("c:\\temp\\results_report.json", "Publish Shape File via Portal", "Fail",
